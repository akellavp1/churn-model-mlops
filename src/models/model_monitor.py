...
from evidently.dashboard.tabs import DataDriftTab, CatTargetDriftTab, ClassificationPerformanceTab, DataQualityTab
...
def model_monitoring(config_path):
    ...
    data_and_target_drift_dashboard = Dashboard(tabs=[DataDriftTab(), CatTargetDriftTab(), DataQualityTab()])
