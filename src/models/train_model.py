...
################### MLFLOW ###############################
    ...
    with mlflow.start_run(run_name=mlflow_config["run_name"]) as mlops_run:
        model = RandomForestClassifier(max_depth=max_depth,n_estimators=n_estimators, min_samples_split=min_samples_split)
        ...
        tracking_url_type_store = urlparse(mlflow.get_artifact_uri(mlflow_config["artifacts_dir"])).path
